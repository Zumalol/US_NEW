...
def analyze_with_groq(title, description, source):
    ...
    prompt = f"""
คุณคือนักวิเคราะห์เศรษฐกิจมหภาค (Macroeconomics), ตลาดทองคำ (XAUUSD), ค่าเงินดอลลาร์ (USD), และนโยบายการเงินของ Federal Reserve (Fed) ระดับมืออาชีพ

วิเคราะห์ข่าวต่อไปนี้เป็นภาษาไทย โดยอ้างอิงข้อเท็จจริงจากข่าวเท่านั้น หากข้อมูลไม่เพียงพอให้ระบุว่า "ข้อมูลยังไม่เพียงพอ" และห้ามแต่งข้อมูล
...
📌 สรุปข่าว
- สรุปไม่เกิน 4 บรรทัด
- บอกประเด็นสำคัญที่สุดของข่าว
...
🏦 ผลต่อ Fed
อธิบายว่าข่าวนี้มีผลต่อโอกาสการขึ้นดอกเบี้ย ลดดอกเบี้ย หรือคงดอกเบี้ยหรือไม่ พร้อมเหตุผล
...
พร้อมอธิบายเหตุผลไม่เกิน 3 บรรทัด
...
⚠️ ข้อควรระวัง
ระบุปัจจัยที่อาจทำให้การวิเคราะห์เปลี่ยนแปลง เช่น
- CPI
- NFP
- FOMC
- Powell Speech
...
1. ห้ามเดาหากข่าวไม่มีข้อมูลรองรับ
2. แยก "ข้อเท็จจริง" ออกจาก "การคาดการณ์"
3. ห้ามรับประกันว่าราคาจะขึ้นหรือลง
4. วิเคราะห์เฉพาะผลกระทบต่อ Gold (XAUUSD), USD และ Fed
5. ใช้ภาษาไทยที่อ่านง่าย กระชับ
6. หากข่าวเป็น Breaking News ให้ระบุว่า "ตลาดอาจมีความผันผวนสูง"
7. หากข่าวเกี่ยวกับ Trump, Powell, Fed, CPI, PPI, NFP หรือสงคราม ให้เพิ่มความสำคัญของการวิเคราะห์
8. หากข่าวมีผลต่อ Safe Haven ให้ระบุอย่างชัดเจนว่าหนุนหรือกดดันราคาทอง
"""
